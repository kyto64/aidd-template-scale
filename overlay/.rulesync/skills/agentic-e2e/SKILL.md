...
name: agentic-e2e
description: |
  E2E UI verification via headless Chrome and CDP. Requires stack-paths.md and a running app.
targets:
  - claudecode
  - agentsskills
...
allowed-tools:
  ...
  - Grep
  - Glob
  - "Bash(.claude/skills/agentic-e2e/launch_chrome.sh *)"
  - "Bash(node .claude/skills/agentic-e2e/cdp_drive.mjs *)"
---
