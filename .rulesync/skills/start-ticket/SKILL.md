...
name: start-ticket
description: |
  Start a GitHub Issue: fetch details, label in-progress, create worktree from origin/main,
  read docs, plan, implement, run quality gates when available, open PR with Fixes #N.
targets:
  - claudecode
  - agentsskills
